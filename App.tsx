...
import { Wink, Nudge, Page, InboxItem, Contact, ReactionType, CommunityExperience, SecondOpinionRequest, NotificationSettings } from './types';
    ...
    const handleCommunityWinkReaction = useCallback((winkId: string, reactionType: ReactionType) => {
        ...
        setCommunityWinks(winks => winks.map(wink => {
            if (wink.id === winkId) {
                ...
                // FIX: Add type guard to ensure outboxWink is of type Wink before accessing recipient
