        ...
        return (
            <div ref={cardRef} className="bg-brand-surface p-4 sm:p-6 rounded-2xl shadow-xl border border-brand-secondary-200/50 animate-fade-in-up">
                ...
                <div className="relative mb-8">
                    <button onClick={() => setIsExpanded(false)} className="absolute left-0 top-1/2 -translate-y-1/2 p-2 rounded-full hover:bg-brand-secondary-100 transition-colors interactive-scale">
