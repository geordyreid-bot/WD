...
import { generateWinkContent, findSocialResources, reverseGeocode, moderateCustomObservable } from '../services/geminiService';
...
export const WinkComposer: React.FC<WinkComposerProps> = ({ onWinkSent, navigate, contacts, onDeleteContact, onToggleBlockContact, onAddContacts }) => {
            ...
            <div className="bg-brand-surface w-full max-w-2xl mx-auto rounded-2xl shadow-xl border border-brand-secondary-200/50 flex flex-col flex-1 relative">
                ...
                <div className="p-6 sm:p-8 flex-shrink-0">
                    <div className="relative mb-8">
                        <button onClick={goBack} className="absolute left-0 top-1/2 -translate-y-1/2 p-2 rounded-full hover:bg-brand-secondary-100 transition-colors interactive-scale">
